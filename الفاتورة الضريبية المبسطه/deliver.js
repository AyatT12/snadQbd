async function CreateReceiptPdf() {
  ...
  const dynamicData = {
    ...
    AfterDiscountitems: [{ content: "320.00" }, { content: "50.00" }, { sum: "370.00" }],
    VATitems: [{ content: "320.00" }, { content: "50.00" }, { sum: "370.00" }],
    Totalitems: [{ content: "320.00" }, { content: "50.00" }, { sum: "370.00" }],
  };
...
const drawReceipt = async (canvas, data) => {
  ...
  const fixedConfig = {
    texts: [
       ...
       { key: "DATE_AR", x: canvas.width - 225, y: 700, align: "right", fontSize:49 },
       { key: "DATE_Num", x: canvas.width - 1235, y: 720, align: "right" , fontSize:49},
       { key: "DATE_EN", x: canvas.width - 225, y: 756, align: "right" },
       { key: "REFERENCE_AR", x: canvas.width - 228, y: 850, align: "right", fontSize:49},
       { key: "REFERENCE_EN", x: canvas.width - 228, y: 905, align: "right" },
       { key: "REFERENCE_NUM", x: canvas.width - 550, y: 875, align: "right" , fontSize:49},
       { key: "TENANT_NAME_AR", x: canvas.width - 280, y: 1015, align: "right" , fontSize:49 },
       { key: "TENANT_NAME_EN", x: canvas.width - 280, y: 1070, align: "right" },
       { key: "CAR_DESCRIPTION_AR", x: canvas.width - 250, y: 1150, align: "right" , fontSize:49  },
       { key: "CAR_DESCRIPTION_EN", x: canvas.width - 250, y: 1205, align: "right" },
