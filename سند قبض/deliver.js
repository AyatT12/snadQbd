(function() {
  async function createAndDisplayReceipt_1() {
  try {
    ...
    const dynamicData = {
      ...
      AMOUNT_EN:
        "Five thousand five hundred and sixty riyals and eighty-two halalas",
      PAYMENT_METHOD_AR: "ماستر كارد",
      PAYMENT_METHOD_EN: "Master Card",
      PAYMENT_DESC_AR:
        "دفعة تحت الحساب لعقد ايجار السيارة لعقد 26-1301-4001105-000303",
      PAYMENT_DESC_EN:
        "Payment on account for car lease contract for contract 24-1301-4001105-000303",
      NOTES_AR:
      ...
      images: {
        background: "سند قبض/Taiba - Receipt Voucher.png",
...
async function drawReceipt(canvas, data) {
  ...
  const imageConfig = [
    ...
    {
      content: data.images.Recipient_signature,
      x: canvas.width - 1400,
      y: 1432,
      width: 171,
      height: 85,
...
function displayResultInNewWindow(canvas) {
  ...
  window.createAndDisplayReceipt_1 = createAndDisplayReceipt_1;
})();